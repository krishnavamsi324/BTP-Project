		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#CollegeApprovalUIworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"CollegeApprovalUIworkflowuimodule-display": {
								"semanticObject": "CollegeApprovalUIworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=CollegeApprovalUI.workflowuimodule",
									"url": sap.ui.require.toUrl("CollegeApprovalUI/workflowuimodule")
								}
							}
						}
					}
